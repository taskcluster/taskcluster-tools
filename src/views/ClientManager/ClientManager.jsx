    ...
    this.setState({ clients: null }, async () => {
      try {
        ...
        const continuationToken =
          clientResponse && clientResponse.continuationToken
            ? clientResponse.continuationToken
            : undefined;
