      ...
      <Row>
        <Col md={12}>
              ...
              <InputGroup>
                ...
                <DropdownButton
                  ...
                  <MenuItem
                    ...
                    onClick={() => this.setEntitySearchMode('Exact')}>
                    <Glyphicon
                      glyph="ok"
                  ...
                  <MenuItem
                    key="scope-mode-has"
                    onClick={() => this.setEntitySearchMode('Has Scope')}>
                    <Glyphicon
                      glyph="ok"
                      style={
                  ...
                  <MenuItem
                    ...
                    onClick={() => this.setEntitySearchMode('Has Sub-Scope')}>
                    <Glyphicon
                      glyph="ok"
                      style={
          ...
          <Table
            condensed={true}
            hover={true}
            className="scopes-inspector-scopes-table">
            <thead>
              <tr>
                <th>
                ...
                <tr key={`scope-roles-${index}`}>
                  <td>
                    <Link
                      ...
                      <Icon name="users" fixedWidth={true} />{' '}
                      <code>{roleId}</code>
                    </Link>
                  </td>
                </tr>
