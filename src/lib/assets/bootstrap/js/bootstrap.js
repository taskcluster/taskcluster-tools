...
+function ($) {
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      const inDom = $.contains(document.documentElement, this.$element[0]);
      ...
      if (autoPlace) {
        ...
        const parentDim = this.getPosition($parent);
  ...
  Tooltip.prototype.applyPlacement = function (offset, placement) {
    ...
    const arrowDelta = delta.left ? delta.left * 2 - width + actualWidth : delta.top * 2 - height + actualHeight;
    const arrowPosition = delta.left ? 'left' : 'top';
    const arrowOffsetPosition = delta.left ? 'offsetWidth' : 'offsetHeight';
