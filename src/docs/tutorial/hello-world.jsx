...
${nextSteps([
  {
    label: 'I want to look at some real tasks',
    path: '/tutorial/finding-tasks'
  },
  {
    label: 'I want to know how to call Taskcluster APIs',
    path: '/tutorial/apis'
  },
  {
    label: "I'm a Firefox/Gecko developer - How do my commits get built?",
    path: '/tutorial/gecko-tasks'
  }
])}
`;
const HelloWorld = props => <ReactMarkdown source={view} {...props} />;
